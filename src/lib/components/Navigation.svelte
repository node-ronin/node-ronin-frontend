...
<div class="container py-5 mx-auto">
  ...
  <nav class="border-gray-200 px-2 ">
    ...
    <a href="https://node-ronin-frontend.vercel.app/" class="flex">
      <img src="/assets/logo2.png" alt="logo" class="h-10 mr-3" >
    ...
    <div class="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
      <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
        <li>
          <a href="https://node-ronin-frontend.vercel.app/" class="bg-blue-700 md:bg-transparent text-white block pl-3 pr-4 py-2 md:text-blue-700 md:p-0 rounded" aria-current="page">Home</a>
        </li>
        <li>
          <a href="/blog" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Blog</a>
        </li>
        <li>
